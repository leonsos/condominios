 ...
 * Page class
 */
class gastos_ind_add extends gastos_ind
{
	...
	// Page object name
	public $PageObjName = "gastos_ind_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_gasto_ind") !== NULL) {
				...
				$this->setKey("id_gasto_ind", $this->id_gasto_ind->CurrentValue); // Set up key
			} else {
				$this->setKey("id_gasto_ind", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "gastos_indview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_gasto_ind->OldValue = $this->id_gasto_ind->CurrentValue;
		...
		$this->hasta->CurrentValue = NULL;
		$this->hasta->OldValue = $this->hasta->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// desde
		$this->desde->setDbValueDef($rsnew, UnFormatDateTime($this->desde->CurrentValue, 0), NULL, FALSE);

		// hasta
		$this->hasta->setDbValueDef($rsnew, UnFormatDateTime($this->hasta->CurrentValue, 0), NULL, FALSE);
