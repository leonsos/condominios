...
class usuarios_edit extends usuarios
{
	...
	protected function loadFormValues()
	{
		...
		$this->id_usuario->setOldValue($CurrentForm->getValue("o_id_usuario"));
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// nombre_usuario
			$this->nombre_usuario->setDbValueDef($rsnew, $this->nombre_usuario->CurrentValue, "", $this->nombre_usuario->ReadOnly);

			// clave
			$this->clave->setDbValueDef($rsnew, $this->clave->CurrentValue, "", $this->clave->ReadOnly || Config("ENCRYPTED_PASSWORD") && $rs->fields('clave') == $this->clave->CurrentValue);
			...
			// cedula
			$this->cedula->setDbValueDef($rsnew, $this->cedula->CurrentValue, 0, $this->cedula->ReadOnly);
			...
			// perfil_id
			$this->perfil_id->setDbValueDef($rsnew, $this->perfil_id->CurrentValue, 0, $this->perfil_id->ReadOnly);
