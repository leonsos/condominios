 ...
 * Page class
 */
class propietarios_delete extends propietarios
{
	...
	// Page object name
	public $PageObjName = "propietarios_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("propietarioslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("propietarioslist.php"); // Return to list
			}
		}
	}
