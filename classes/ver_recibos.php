...
class ver_recibos
{
	...
	// Table name
	public $TableName = 'ver_recibos.php';

	// Page object name
	public $PageObjName = "ver_recibos";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'ver_recibos.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "ver_recibos", $url, "", "ver_recibos", TRUE);
		$this->Heading = $Language->TablePhrase("ver_recibos", "TblCaption"); 
	}
} // End class
?>