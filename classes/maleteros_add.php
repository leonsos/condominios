 ...
 * Page class
 */
class maleteros_add extends maleteros
{
	...
	// Page object name
	public $PageObjName = "maleteros_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_maletero") !== NULL) {
				...
				$this->setKey("id_maletero", $this->id_maletero->CurrentValue); // Set up key
			} else {
				$this->setKey("id_maletero", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "maleterosview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_maletero->OldValue = $this->id_maletero->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_maletero'] = $this->id_maletero->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// nombre_numero
		$this->nombre_numero->setDbValueDef($rsnew, $this->nombre_numero->CurrentValue, NULL, FALSE);
