 ...
 * Page class
 */
class propietarios_edit extends propietarios
{
	...
	// Page object name
	public $PageObjName = "propietarios_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_propietario")) {
				$this->id_propietario->setFormValue($CurrentForm->getValue("x_id_propietario"));
			}
		} else {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->id_propietario->IsDetailKey)
			$this->id_propietario->setFormValue($val);
	...
	{
		global $CurrentForm;
		$this->id_propietario->CurrentValue = $this->id_propietario->FormValue;
	...
	protected function validateForm()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return ($FormError == "");
		if ($this->id_propietario->Required) {
			if (!$this->id_propietario->IsDetailKey && $this->id_propietario->FormValue != NULL && $this->id_propietario->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->id_propietario->caption(), $this->id_propietario->RequiredErrorMessage));
			}
		}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// telefono_princip
			$this->telefono_princip->setDbValueDef($rsnew, $this->telefono_princip->CurrentValue, NULL, $this->telefono_princip->ReadOnly);

			// telefono_secund
			$this->telefono_secund->setDbValueDef($rsnew, $this->telefono_secund->CurrentValue, NULL, $this->telefono_secund->ReadOnly);
