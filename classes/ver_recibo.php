...
class ver_recibo
{
	...
	// Table name
	public $TableName = 'ver_recibo.php';

	// Page object name
	public $PageObjName = "ver_recibo";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'ver_recibo.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "ver_recibo", $url, "", "ver_recibo", TRUE);
		$this->Heading = $Language->TablePhrase("ver_recibo", "TblCaption"); 
	}
} // End class
?>