 ...
 * Page class
 */
class recibos_delete extends recibos
{
	...
	// Page object name
	public $PageObjName = "recibos_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("reciboslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("reciboslist.php"); // Return to list
			}
		}
	}
