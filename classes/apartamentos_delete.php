 ...
 * Page class
 */
class apartamentos_delete extends apartamentos
{
	...
	// Page object name
	public $PageObjName = "apartamentos_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("apartamentoslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("apartamentoslist.php"); // Return to list
			}
		}
	}
