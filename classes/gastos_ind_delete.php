 ...
 * Page class
 */
class gastos_ind_delete extends gastos_ind
{
	...
	// Page object name
	public $PageObjName = "gastos_ind_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gastos_indlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gastos_indlist.php"); // Return to list
			}
		}
	}
