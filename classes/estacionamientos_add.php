 ...
 * Page class
 */
class estacionamientos_add extends estacionamientos
{
	...
	// Page object name
	public $PageObjName = "estacionamientos_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_estacionamiento") !== NULL) {
				...
				$this->setKey("id_estacionamiento", $this->id_estacionamiento->CurrentValue); // Set up key
			} else {
				$this->setKey("id_estacionamiento", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "estacionamientosview.php")
