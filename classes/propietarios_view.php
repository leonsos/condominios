 ...
 * Page class
 */
class propietarios_view extends propietarios
{
	...
	// Page object name
	public $PageObjName = "propietarios_view";
	...
	public function __construct()
	{
		...
		if (Get("id_propietario") !== NULL) {
			$this->RecKey["id_propietario"] = Get("id_propietario");
			$keyUrl .= "&amp;id_propietario=" . urlencode($this->RecKey["id_propietario"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_propietario") !== NULL) {
				...
				$this->RecKey["id_propietario"] = $this->id_propietario->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->id_propietario->setQueryStringValue(Key(0));
				$this->RecKey["id_propietario"] = $this->id_propietario->QueryStringValue;
			} elseif (Post("id_propietario") !== NULL) {
				$this->id_propietario->setFormValue(Post("id_propietario"));
				$this->RecKey["id_propietario"] = $this->id_propietario->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->id_propietario->setFormValue(Route(2));
				$this->RecKey["id_propietario"] = $this->id_propietario->FormValue;
			} else {
				$returnUrl = "propietarioslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "propietarioslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "propietarioslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
