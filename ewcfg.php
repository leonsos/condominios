...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "condominios"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'gYaIgES1wmjNj2s0', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/condominios.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{ADBDD478-1F96-44BD-9F21-FE9B46199DE2}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "condominios"]
	],
	...
	"LOGIN_USERNAME_FIELD_NAME" => "nombre_usuario",
	...
	"USER_TABLE_DBID" => "DB",
	"USER_TABLE" => "`usuarios`",
	"USER_NAME_FILTER" => "(`nombre_usuario` = '%u')",
	"USER_ID_FILTER" => "",
	"USER_EMAIL_FILTER" => "",
