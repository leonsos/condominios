...
<input type="hidden" name="x_id_perfil" id="x_id_perfil" value="<?php echo $userpriv->id_perfil->CurrentValue ?>">
<div class="ew-desktop">
<div class="card ew-card ew-user-priv">
<div class="card-header">
	<h3 class="card-title"><?php echo $Language->phrase("UserLevel") ?><?php echo $Security->getUserLevelName((int)$userpriv->id_perfil->CurrentValue) ?> (<?php echo $userpriv->id_perfil->CurrentValue ?>)</h3>
